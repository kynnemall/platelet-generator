...
class ResConvEncoder(BaseEncoder):
    def __init__(self, args):
        BaseEncoder.__init__(self)
        self.name = 'ResConv_v1'
        self.l1 = DepthwiseSeparableConv(in_channels=1, out_channels=32, kernel_size=3, stride=1)
        self.rl1 = DepthwiseSeparableConv(in_channels=1, out_channels=32, kernel_size=1, stride=1)
        self.l2 = DepthwiseSeparableConv(in_channels=32, out_channels=64, kernel_size=3, stride=1)
        self.rl2 = DepthwiseSeparableConv(in_channels=32, out_channels=64, kernel_size=1, stride=1)
        self.l3 = DepthwiseSeparableConv(in_channels=64, out_channels=128, kernel_size=3, stride=1)
        self.rl3 = DepthwiseSeparableConv(in_channels=64, out_channels=128, kernel_size=1, stride=1)
    ...
    def forward(self, x):
        ...
        x = self.max_pool(x)
        x = self.l3(x) + self.rl3(x)
        x = self.max_pool(x)
        x = self.l4(x) + self.rl4(x)
        x = self.max_pool(x)
...
class ResConvDecoder(BaseDecoder):
    def __init__(self, args):
        ...
        self.rl1 = DepthwiseSeparableConv(in_channels=args.latent_dim, out_channels=256, kernel_size=1, stride=1)
        self.l2 = DepthwiseSeparableConv(in_channels=256, out_channels=128, kernel_size=3, stride=1)
        self.rl2 = DepthwiseSeparableConv(in_channels=256, out_channels=128, kernel_size=1, stride=1)
        self.l3 = DepthwiseSeparableConv(in_channels=128, out_channels=64, kernel_size=3, stride=1)
        self.rl3 = DepthwiseSeparableConv(in_channels=128, out_channels=64, kernel_size=1, stride=1)
        self.l4 = DepthwiseSeparableConv(in_channels=64, out_channels=32, kernel_size=3, stride=1)
        self.rl4 = DepthwiseSeparableConv(in_channels=64, out_channels=32, kernel_size=1, stride=1)
